...
<div class="card">
    <div class="card-body">
        ...
        <form method="post" action="<?php echo e(route('dashboard.posts.update', [$post->slug])); ?>" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12 mt-2">
                ...
                <div class="col-sm-10">
                    <?php if($post->image): ?>
                        <img src="<?php echo e(asset('storage/' . $post->image)); ?>" class="img-preview img-fluid mb-3 col-sm-5" alt="<?php echo e($post->title); ?>">
                    <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('back.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bapenda\resources\views/back/dashboard/edit-post.blade.php ENDPATH**/ ?>