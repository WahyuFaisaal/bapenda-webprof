...
<div class="card">
    <div class="card-body">
        ...
        <form method="post" action="<?php echo e(route('dashboard.posts.update', [$post->slug])); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bapenda\resources\views/admin/edit-post.blade.php ENDPATH**/ ?>