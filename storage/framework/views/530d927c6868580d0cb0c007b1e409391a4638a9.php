  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        ...
        <li>
            <a href="<?php echo e(route('dashboard.taxes')); ?>/<?php echo e($tax->id); ?>">
...
</aside><!-- End Sidebar--><?php /**PATH C:\laragon\www\bapenda\resources\views/admin/partials/sidebar.blade.php ENDPATH**/ ?>