...
<?php $__env->startSection('content'); ?>
    ...
    <section id="main-container" class="main-container">
        ...
        <div class="row">
            <div class="col-lg-6">
                <h3 class="column-title">Siapa Kami</h3>
                <p>Pajak Daerah merupakan salah satu sumber pendapatan asli daerah yang memiliki peranan yang sangat strategis dalam meningkatkan kemampuan keuangan daerah dan akan digunakan untuk keperluan daerah bagi sebesar-besarnya kemakmuran rakyat. Badan Pengelolaan Keuangan dan Pajak Daerah merupakan instansi yang berfungsi mengelola pendapatan daerah dari sektor pajak dan mengelola keuangan daerah Kabupaten Gowa.</p>
                <blockquote><p>BAPENDA adalah layanan helpdesk terintegrasi milik BAPENDA Kab. Gowa. Layanan BAPENDA Mencakup layanan atas tugas dan fungsi BAPENDA, termasuk Layanan Aplikasi seperti (SIMPAD, KSWPD dll) </p></blockquote>
                <p></p>
...
<?php echo $__env->make('front.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bapenda\resources\views/front/about.blade.php ENDPATH**/ ?>