...
<div class="post-content post-single">
    ...
    <?php if($post->image): ?>
        <img loading="lazy" src="<?php echo e(asset('storage/' . $post->image)); ?>" class="img-fluid" alt="post-image">
    <?php else: ?>    
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bapenda\resources\views/admin/single-post.blade.php ENDPATH**/ ?>